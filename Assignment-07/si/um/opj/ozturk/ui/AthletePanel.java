...
public class AthletePanel extends JPanel {
    ...
    public AthletePanel() {
        ...
        topPanel.setBorder(
                BorderFactory.createTitledBorder("Athlete Information")
        );
        ...
        scrollPane.setBorder(
                BorderFactory.createTitledBorder("Athletes")
        );
    ...
    private void fillForm() {
        ...
        if (athlete != null) {
            ...
            dateField.setText(
                    athlete.getBirthDate().toString()
            );

            disciplineBox.setSelectedItem(
                    athlete.getSportsDiscipline()
            );
        }
    }
