...
public class Match extends Event implements Competition {
    ...
    // ATHLETE ADD WITH VALIDATION + DUPLICATE CHECK
    public void addAthleteToMatch(Athlete athlete) throws AddingAthleteException {
        ...
        for (Athlete a : athletesList) {
            if (a != null && a.equals(athlete)) {
                throw new AddingAthleteException("Athlete already added to this match!");
            }
        }
        ...
        for (Match m : venue.getMatchList()) {
            if (m == this) {
                System.out.println("Match " + getName() +
                        " is assigned to venue " + venue.getName());
                return;
            }
        }
